## SharePoint Server 2010: PowerShell Script To List Details On All Site Templates In A Farm ##
...
Get-SPWebTemplateWithId | Format-Table | Out-File "C:\BoxBuild\Scripts\PowerShell\SP2010_Site_Templates.txt"