## SharePoint Server 2010: PowerShell Script to provision a new Site Collection in it's own Content Database ##
## Usage: After provisioning the Site Collection; when you go to the $site URL you will need to choose a site template
##        The content database will be visible in Central Admin under: Central Administration -- Manage Content Databases 
